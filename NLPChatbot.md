...
Da notare che progetti open source disponibili ad uso gratuito, hanno il vantaggio di non avere costi per l’utilizzo degli stessi ma non significa che non abbiano vincoli di licenze. Inoltre, chi mantiene vivo ad oggi il progetto può decidere domani di non renderlo più accessibile e/o gratuito e non non ne garantisce la funzionalità nel tempo. Il rischio di investire risorse in strumenti che non possono garantire una continuità è elevato ed il mio consiglio è di valutare una sperimentazione di questo tipo solo in una fase esplorativa.
